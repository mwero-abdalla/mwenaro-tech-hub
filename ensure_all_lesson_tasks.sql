-- Ensure ALL lessons have both quiz questions and project requirements
-- This script will:
-- 1. Set has_project = true for all lessons
-- 2. Add quiz questions for lessons that don't have any

-- Step 1: Enable projects for ALL lessons
UPDATE lessons SET has_project = true WHERE has_project = false OR has_project IS NULL;

-- Step 2: Add quiz questions for lessons missing them
DO $$
DECLARE
