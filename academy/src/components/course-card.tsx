        ...
        <Card className={`flex flex-col overflow-hidden h-full group transition-all duration-500 hover:shadow-[0_20px_50px_rgba(232,93,59,0.15)] border-white/5 bg-white dark:bg-zinc-900 rounded-[2rem] hover:-translate-y-2 ${!isPublished ? 'opacity-75 grayscale-[0.5] hover:opacity-100 hover:grayscale-0' : ''}`}>
            ...
            <CardHeader className="p-8 pb-3">
                <div className="flex items-start justify-between gap-4">
                    <div>
                        <div className="flex items-center gap-2 mb-3 opacity-90 flex-wrap">
                            ...
                            <span className="text-[10px] font-semibold text-muted-foreground/80 lowercase tracking-widest">(4.9)</span>
                            <div className="flex gap-1.5 ml-auto">
                                <span className="px-2 py-0.5 bg-primary/10 text-primary text-[9px] font-black uppercase tracking-widest rounded-md border border-primary/20">
