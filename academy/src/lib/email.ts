...
export async function sendNotificationEmail(userEmail: string, title: string, content: string, link?: string) {
    const html = `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px;">
            <h2 style="color: #E85D3B;">Mwenaro Academy</h2>
            <h3>${title}</h3>
            <p>${content}</p>
            ...
            <p style="font-size: 12px; color: #64748b;">You are receiving this because you have notifications enabled at Mwenaro Academy.</p>
        </div>
    `
